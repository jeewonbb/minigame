...
let break_arr = [];
let fondant_arr = [];
export function AnalysisData2(props) {
  // list = props.list;
  // console.log(list);
    ...
    <>
      <div className="graph-wrap">
        ...
        <div className="graph-header">
          ...
          <div className="right">
            <p>
              ...
              <small>{breaking[2]}번</small>
            </p>
            <p>
              <span className="badge fondant">퐁당</span>
              <small>{fondant[2]}번</small>
            </p>
          </div>
        </div>
        <div className="graph-inner">
          <div
            className="graph-box"
            style={{ width: analysisSize3 * 20 + "px" }}
            dangerouslySetInnerHTML={{ __html: analysis_list3 }}
          ></div>
        </div>
      </div>
      <div className="graph-wrap">
        ...
        <div className="graph-header">
          ...
          <div className="right">
            <p>
              <span className="badge breaking">꺽음</span>
              <small>{breaking[3]}번</small>
            </p>
            <p>
              <span className="badge fondant">퐁당</span>
              <small>{fondant[3]}번</small>
            </p>
          </div>
        </div>
        <div className="graph-inner">
          <div
            className="graph-box"
            style={{ width: analysisSize4 * 20 + "px" }}
            dangerouslySetInnerHTML={{ __html: analysisPatternlist4 }}
          ></div>
        </div>
      </div>
    </>
